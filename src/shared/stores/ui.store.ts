...
export {
  ...
  TRACKER_THOUGHT_BUBBLE_DISPLAYS,
...
export const useUIStore = create<UIState>()(
  persist(
    (set, get) => ({
      ...
      collapseHiddenAiMessages: false,
      ...
      setTrackerPanelSizeProfile: (profile) => set({ trackerPanelSizeProfile: profile }),
      setTrackerPanelThoughtBubbleDisplay: (display) => set({ trackerPanelThoughtBubbleDisplay: display }),
      setTrackerPanelDockedThoughtsAlwaysVisible: (visible) =>
        set({ trackerPanelDockedThoughtsAlwaysVisible: visible }),
      setTrackerTemperatureUnit: (unit) => set({ trackerTemperatureUnit: unit }),
      ...
      setCollapseHiddenAiMessages: (v) => set({ collapseHiddenAiMessages: v }),
